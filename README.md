...
### Part1<br>
วิธีที่ใช้ระยะื่งที่สั้นที่สุดคือ RRT* เนื่องจากไม่ได้เคลื่อนที่แบบที่ละพิกเซลจึงใช้ระยะทางเพียง 958.99 หากคิดเฉพาะวิฑีที่เดินทีละ พิกเซล A*และ Breadth firstจะเร็วที่สุดที่ 990.79 
ในด้านความเร็ว Best first จะไวที่สุดที่ 0.06s
